<template>
  <div class="container">
    <h1 class="text-center mt-3 mb-3">Makanan Favoritmu</h1>
    <div class="row">
      <div class="col-md-4" v-for="f in favoritku" v-bind:key="f.index">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
              ...
              <button type="button" class="btn btn-outline-danger btn-block"  data-toggle="modal" data-target="#staticBackdrop" @click="detail(f.id)">Detail Makanan</button>
